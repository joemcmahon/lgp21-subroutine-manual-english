...
The data must conform to the floating-point layout required by \ref{H1-11.0}. Dimensions must be less than 64, and total memory overhead requires a block of $(n \times m) + (m \times p) + (n \times p)$ locations to accommodate the inputs and the trailing results workspace.
