...
\subsection*{BINARY CONVERSION OF WHOLE NUMBERS 1 --- L3-10.0}
\addcontentsline{toc}{subsection}{BINARY CONVERSION OF WHOLE NUMBERS 1 --- L3-10.0}

\subsubsection*{PURPOSE}
\texttt{L3-10.0} converts a positive 8-digit decimal number into its binary equivalent. Leading zeros must be explicitly included.
...
\textbf{Memory used:} 58 sectors, 58 words (starting at sector 00) \\
...
The instruction at 1200 loads the data word containing the decimal integer representation. The instruction at 1201 sets the return path to location 1203 inside the subroutine's exit tracking line (at $0800 + 42$). Location 1202 triggers the jump to the routine. Upon return to location 1203, the accumulator contains the true binary value equivalent to \texttt{0x6000} (decimal $24576$) correctly shifted to $q=30$.
