...
A third, even more astounding calling sequence passes a multi-word floating-point\footnote{While the LGP-21 lacks floating-point \emph{hardware}, it relies entirely on a software-driven floating-point math \emph{interpreter}. See Section~\ref{H1-11.0}.} number to a subroutine as an argument.
